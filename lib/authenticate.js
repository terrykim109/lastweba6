...
// NOTE: The following helper functions are not strictly necessary if you rely on the useAuth hook,
// but they're kept here for completeness. The setToken function here has been updated.
...
export async function registerUser(user, password, password2) {
  try {
    console.log("[registerUser] Registering user:", user);
...
export async function authenticateUser(user, password) {
  try {
    console.groupCollapsed("[authenticateUser] Starting authentication");
